              ...
              <table className="w-full text-base">
                <thead>
                  <tr className="text-left border-b">
                    <th scope="col" className="py-2 px-2 sm:px-3 text-xs font-semibold text-gray-600">Team</th>
                    <th scope="col" className="py-2 px-2 sm:px-3 text-xs font-semibold text-gray-600 text-center">W</th>
                    <th scope="col" className="py-2 px-2 sm:px-3 text-xs font-semibold text-gray-600 text-center">L</th>
                    <th scope="col" className="py-2 px-2 sm:px-3 text-xs font-semibold text-gray-600 text-center">T</th>
                    <th scope="col" className="py-2 px-2 sm:px-3 text-xs font-semibold text-gray-600 text-center">Pct</th>
                  </tr>
                </thead>
                <tbody>
                  {standingsLoading ? (
