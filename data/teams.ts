...
export const teams: Record<string, TeamData> = {
  ...
  'baltimore-ravens': {
    ...
    specialTeamsCoordinator: 'Anthony Levine Sr.',
  ...
  'buffalo-bills': {
    ...
    defensiveCoordinator: 'Jim Leonhard',
  ...
  'cleveland-browns': {
    ...
    offensiveCoordinator: 'Travis Switzer',
    defensiveCoordinator: 'Mike Rutenberg',
    specialTeamsCoordinator: 'Byron Storer',
  ...
  'dallas-cowboys': {
    ...
    defensiveCoordinator: 'Christian Parker',
  ...
  'denver-broncos': {
    ...
    offensiveCoordinator: 'Davis Webb',
  ...
  'green-bay-packers': {
    ...
    defensiveCoordinator: 'Jonathan Gannon',
    specialTeamsCoordinator: 'Cam Achord',
  ...
  'las-vegas-raiders': {
    ...
    offensiveCoordinator: 'Andrew Janocko',
    defensiveCoordinator: 'Rob Leonard',
    specialTeamsCoordinator: 'Joe DeCamillis',
  ...
  'los-angeles-chargers': {
    ...
    offensiveCoordinator: 'Mike McDaniel',
    defensiveCoordinator: 'Chris O\'Leary',
  ...
  'los-angeles-rams': {
    ...
    offensiveCoordinator: 'Nate Scheelhaase',
  ...
  'miami-dolphins': {
    ...
    record: '0-0-0',
    divisionRank: '0th',
    generalManager: 'Jon-Eric Sullivan',
    headCoach: 'Jeff Hafley',
    offensiveCoordinator: 'Bobby Slowik',
    defensiveCoordinator: 'Sean Duggan',
  ...
  'new-orleans-saints': {
    ...
    specialTeamsCoordinator: 'Phil Galiano',
  ...
  'new-york-jets': {
    ...
    defensiveCoordinator: 'Brian Duker',
    specialTeamsCoordinator: 'Chris Banjo',
    homeVenue: 'MetLife Stadium',
    location: 'East Rutherford, NJ',
    stats: {
  ...
  'philadelphia-eagles': {
    ...
    offensiveCoordinator: 'Sean Mannion',
  ...
  'pittsburgh-steelers': {
    ...
    offensiveCoordinator: 'Brian Angelichio',
    defensiveCoordinator: 'Patrick Graham',
    specialTeamsCoordinator: 'Danny Crossman',
  ...
  'seattle-seahawks': {
    ...
    offensiveCoordinator: 'Brian Fleury',
  ...
  'washington-commanders': {
    ...
    headCoach: 'Dan Quinn',
    offensiveCoordinator: 'David Blough',
    defensiveCoordinator: 'Daronte Jones',
